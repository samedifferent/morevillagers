...
public class ModProfessions {
    ...
    public static final VillagerProfession NETHERIAN = VillagerProfession.register("netherian", NETHERIAN_POI, SoundEvents.VILLAGER_WORK_BUTCHER);
    public static final VillagerProfession WOODWORKER = VillagerProfession.register("woodworker", WOODWORKER_POI, SoundEvents.VILLAGER_WORK_LEATHERWORKER);
    public static final VillagerProfession ENDERIAN = VillagerProfession.register("enderian", ENDERIAN_POI, SoundEvents.VILLAGER_WORK_BUTCHER);
    public static final VillagerProfession ENGINEER = VillagerProfession.register("engineer", ENGINEER_POI, SoundEvents.VILLAGER_WORK_TOOLSMITH);
    public static final VillagerProfession FLORIST = VillagerProfession.register("florist", FLORIST_POI, SoundEvents.VILLAGER_WORK_FARMER);
    public static final VillagerProfession HUNTER = VillagerProfession.register("hunter", HUNTER_POI, SoundEvents.VILLAGER_WORK_FLETCHER);
    public static final VillagerProfession MINER = VillagerProfession.register("miner", MINER_POI, SoundEvents.VILLAGER_WORK_ARMORER);
