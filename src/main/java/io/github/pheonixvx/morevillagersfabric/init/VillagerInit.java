...
public class VillagerInit {
    ...
    public static void fillTradeData() {
        ...
        TradeOffers.Factory[] floristLevel1 = new TradeOffers.Factory[]{
                new TradeOffers.SellItemFactory(Items.DANDELION, 1, 8, 16, 1),
                new TradeOffers.SellItemFactory(Items.POPPY, 1, 8, 16, 1),
                new TradeOffers.SellItemFactory(Items.BLUE_ORCHID, 1, 8, 16, 1),
                new TradeOffers.SellItemFactory(Items.ALLIUM, 1, 8, 16, 1),
                new TradeOffers.SellItemFactory(Items.AZURE_BLUET, 1, 8, 16, 1),
                new TradeOffers.SellItemFactory(Items.RED_TULIP, 1, 8, 16, 1),
                new TradeOffers.SellItemFactory(Items.ORANGE_TULIP, 1, 8, 16, 1),
                new TradeOffers.SellItemFactory(Items.WHITE_TULIP, 1, 8, 16, 1),
                new TradeOffers.SellItemFactory(Items.PINK_TULIP, 1, 8, 16, 1),
                new TradeOffers.SellItemFactory(Items.OXEYE_DAISY, 1, 8, 16, 1),
                new TradeOffers.SellItemFactory(Items.CORNFLOWER, 1, 8, 16, 1),
                new TradeOffers.SellItemFactory(Items.LILY_OF_THE_VALLEY, 1, 8, 16, 1),
                new TradeOffers.SellItemFactory(Items.SUNFLOWER, 1, 8, 16, 1),
                new TradeOffers.SellItemFactory(Items.LILAC, 1, 8, 16, 1),
                new TradeOffers.SellItemFactory(Items.ROSE_BUSH, 1, 8, 16, 1),
                new TradeOffers.SellItemFactory(Items.PEONY, 1, 8, 16, 1)
        };
