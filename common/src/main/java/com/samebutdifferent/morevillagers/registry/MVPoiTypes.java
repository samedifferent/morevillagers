...
public class MVPoiTypes {
    ...
    public static final Supplier<PoiType> OCEANOGRAPHER_POI = CommonPlatformHelper.registerPoiType("oceanographer", () -> PoiTypeInvoker.invokeConstructor("oceanographer", getBlockStates(MVBlocks.OCEANOGRAPHY_TABLE), 1, 1));
    public static final Supplier<PoiType> NETHERIAN_POI = CommonPlatformHelper.registerPoiType("netherian", () -> PoiTypeInvoker.invokeConstructor("netherian", getBlockStates(MVBlocks.DECAYED_WORKBENCH), 1, 1));
    public static final Supplier<PoiType> WOODWORKER_POI = CommonPlatformHelper.registerPoiType("woodworker", () -> PoiTypeInvoker.invokeConstructor("woodworker", getBlockStates(MVBlocks.WOODWORKING_TABLE), 1, 1));
    public static final Supplier<PoiType> ENDERIAN_POI = CommonPlatformHelper.registerPoiType("enderian", () -> PoiTypeInvoker.invokeConstructor("enderian", getBlockStates(MVBlocks.PURPUR_ALTAR), 1, 1));
